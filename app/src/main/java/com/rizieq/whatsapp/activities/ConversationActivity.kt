...
import com.rizieq.whatsapp.adapters.ConversationAdapter
import com.rizieq.whatsapp.utils.Constants.DATA_CHATS
import com.rizieq.whatsapp.utils.Constants.DATA_CHAT_MESSAGE
import com.rizieq.whatsapp.utils.Constants.DATA_CHAT_MESSAGE_TIME
import com.rizieq.whatsapp.utils.Constants.DATA_USERS
import com.rizieq.whatsapp.utils.Message
                        ...
                        for (change in querySnapshot.documentChanges) {
                            when (change.type) {
                                DocumentChange.Type.ADDED -> {
                                    ...
                                    if (message != null) {
                                        conversationAdapter.addMessage(message) // menambah pesan
                                        rv_message.post {
                                            // memasangkan data Message ke RecyclerView
        ...
        imbtn_send.setOnClickListener {
            if (!edt_message.text.isNullOrEmpty()) {
                ...
                firebaseDb.collection(DATA_CHATS) // menambahkan data message ke dalam
                    ...
                    .document()
                    .set(message)
                edt_message.setText("", TextView.BufferType.EDITABLE) // membersihkan EditText
            }
        }
